...
class Unstichcard2 extends Component {
    state = {} 
    render() { 
        return (
  ...
  <div class="card-body">
    ...
    <a style={{border:"1px solid black",backgroundColor:"black"}} href="#" class="btn btn-primary">View Details</a>
  </div>
</div>
